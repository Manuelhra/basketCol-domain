...
export class TeamAllTimeStats extends Stats<ITeamAllTimeStatsPrimitives> {
  ...
  public incrementStatsAfterGame(
    ...
    return TeamAllTimeStats.create(
      ...
      this.totalOffensiveRebounds.value + totalOffensiveRebounds,
      this.totalDefensiveRebounds.value + totalDefensiveRebounds,
      this.totalAssists.value + totalAssists,
      this.totalSteals.value + totalSteals,
      this.totalBlocks.value + totalBlocks,
      this.totalFouls.value + totalFouls,
      this.totalTurnovers.value + totalTurnovers,
      this.totalThreePointersAttempted.value + totalThreePointersAttempted,
      this.totalThreePointersMade.value + totalThreePointersMade,
      this.totalFreeThrowsAttempted.value + totalFreeThrowsAttempted,
      this.totalFreeThrowsMade.value + totalFreeThrowsMade,
      this.totalFieldGoalsAttempted.value + totalFieldGoalsAttempted,
