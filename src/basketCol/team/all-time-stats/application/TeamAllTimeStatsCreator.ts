...
import { TeamAllTimeStatsRepository } from '../domain/repository/TeamAllTimeStatsRepository';
...
export class TeamAllTimeStatsCreator {
  ...
  readonly #teamAllTimeStatsRepository: TeamAllTimeStatsRepository;

  public constructor(dependencies: {
    idUniquenessValidatorService: IdUniquenessValidatorService;
    teamValidationService: TeamValidationService;
    businessDateService: BusinessDateService;
    teamAllTimeStatsRepository: TeamAllTimeStatsRepository;
  }) {
