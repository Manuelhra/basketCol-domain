...
export class LeagueSeasonFixtureGame extends FixtureGame<ILeagueSeasonFixtureGamePrimitives> {
  ...
  public override get toPrimitives(): ILeagueSeasonFixtureGamePrimitives {
    return {
      ...
      homeTeamId: this.homeTeamId.value,
      awayTeamId: this.awayTeamId.value,
      ...
      quarter: this.quarter.quarterAsNumberOrNull,
      ...
      headRefereeId: this.headRefereeId.value,
      assistantRefereeId: this.assistantRefereeId.value,
      courtId: this.courtId.value,
      fixtureId: this.fixtureId.value,
