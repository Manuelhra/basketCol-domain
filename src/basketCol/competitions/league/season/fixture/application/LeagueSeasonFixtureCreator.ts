...
import { LeagueSeasonFixtureRepository } from '../domain/repository/LeagueSeasonFixtureRepository';
...
export class LeagueSeasonFixtureCreator {
  ...
  constructor(dependencies: {
    ...
    leagueSeasonFixtureRepository: LeagueSeasonFixtureRepository;
  }) {
