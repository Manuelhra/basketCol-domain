...
import { IPhysicalAttributesRepository } from '../../domain/repository/IPhysicalAttributesRepository';
...
export class CreatePhysicalAttributesUseCase {
  ...
  readonly #physicalAttributesRepository: IPhysicalAttributesRepository;

  constructor(dependencies: {
    idUniquenessValidatorService: IdUniquenessValidatorService;
    playerUserValidationService: PlayerUserValidationService;
    businessDateService: BusinessDateService;
    physicalAttributesRepository: IPhysicalAttributesRepository;
  }) {
