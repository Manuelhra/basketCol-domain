...
import { IFinishingAttributesRepository } from '../../domain/repository/IFinishingAttributesRepository';
...
export class CreateFinishingAttributesUseCase {
  ...
  readonly #finishingAttributesRepository: IFinishingAttributesRepository;

  constructor(dependencies: {
    idUniquenessValidatorService: IdUniquenessValidatorService;
    playerUserValidationService: PlayerUserValidationService;
    businessDateService: BusinessDateService;
    finishingAttributesRepository: IFinishingAttributesRepository;
  }) {
