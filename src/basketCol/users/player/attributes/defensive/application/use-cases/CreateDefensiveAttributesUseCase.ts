...
import { IDefensiveAttributesRepository } from '../../domain/repository/IDefensiveAttributesRepository';
...
export class CreateDefensiveAttributesUseCase {
  ...
  readonly #defensiveAttributesRepository: IDefensiveAttributesRepository;

  constructor(dependencies: {
    idUniquenessValidatorService: IdUniquenessValidatorService;
    playerUserValidationService: PlayerUserValidationService;
    businessDateService: BusinessDateService;
    defensiveAttributesRepository: IDefensiveAttributesRepository;
  }) {
